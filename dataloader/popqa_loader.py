...
def get_loader_PopQA(args, tokenizer, train_file_path, dev_file_path, test_file_path) :
    
    train_dataset = PopQA(args, train_file_path, tokenizer)
    train_data_loader = DataLoader(dataset=train_dataset,
                                   batch_size=args.train_batch_size,
                                   shuffle=False,
                                   pin_memory=True,
                                   num_workers=args.num_workers,
                                   collate_fn=collate_fn_PopQA,
                                  )       

    # for demonstration
    dev_dataset = PopQA(args, dev_file_path, tokenizer)
    ...
    test_dataset = PopQA(args, test_file_path, tokenizer)
