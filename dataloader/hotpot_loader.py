...
def get_loader_Hotpot(args, tokenizer, train_file_path, dev_file_path, test_file_path) :
    
    train_dataset = Hotpot(args, train_file_path, tokenizer)
    ...
    # for demonstration
    dev_dataset = Hotpot(args, dev_file_path, tokenizer)
    ...
    test_dataset = Hotpot(args, test_file_path, tokenizer)
