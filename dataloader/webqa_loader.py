...
def get_loader_WebQA(args, tokenizer, train_file_path, dev_file_path, test_file_path) :
    
    train_dataset = WebQA(args, train_file_path, tokenizer)
    train_data_loader = DataLoader(dataset=train_dataset,
                                   batch_size=args.train_batch_size,
                                   shuffle=False,
                                   pin_memory=True,
                                   num_workers=args.num_workers,
                                   collate_fn=collate_fn_WebQA,
                                  )       

    # for demonstration
    dev_dataset = WebQA(args, dev_file_path, tokenizer)
    ...
    test_dataset = WebQA(args, test_file_path, tokenizer)
