...
def get_loader_HEADQA(args, triever_tokenizer, train_file_path, dev_file_path, test_file_path, rewrite_train_file_path, rewrite_dev_file_path, rewrite_test_file_path) :
    
    train_dataset = HEADQA(args, train_file_path, triever_tokenizer, rewrite_train_file_path)
    ...
    # for demonstration
    dev_dataset = HEADQA(args, dev_file_path, triever_tokenizer, rewrite_dev_file_path)
    ...
    test_dataset = HEADQA(args, test_file_path, triever_tokenizer, rewrite_test_file_path)
