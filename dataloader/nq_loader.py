...
def get_loader_NQ(args, tokenizer, train_file_path, dev_file_path, test_file_path) :
    
    train_dataset = NQ(args, train_file_path, tokenizer)
    ...
    # for demonstration
    dev_dataset = NQ(args, dev_file_path, tokenizer)
    ...
    test_dataset = NQ(args, test_file_path, tokenizer)
